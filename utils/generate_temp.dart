...
void main() {
  ...
  TempGen(api,
    ...
    literalTypes: [
      ...
      .litIntTypedList('UnsignedInt', abbr: 'UInt', underlyingType: 'Uint32'),
      .litIntTypedList('Int8'),
      .litIntTypedList('Uint8', abbr: 'UInt8'),
      .litIntTypedList('Int16'),
      .litIntTypedList('Uint16', abbr: 'UInt16'),
      .litIntTypedList('Int32'),
      .litIntTypedList('Uint32', abbr: 'UInt32'),
      .litIntTypedList('Int64'),
      .litIntTypedList('Uint64', abbr: 'UInt64'),
      .litIntTypedList('Char', underlyingType: 'Int8'),
      .litIntTypedList('UnsignedChar', abbr: 'UChar', underlyingType: 'Uint8'),
      .litIntTypedList('UnsignedShort', abbr: 'UShort', underlyingType: 'Uint16'),
