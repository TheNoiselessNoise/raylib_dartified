...
void main()
{
  ...
  final center = Vector2$.val.At('center').set(
    (GetScreenWidth() - 300)/2.0, GetScreenHeight()/2.0
  );

  final innerRadius = Float32$.val.Value(80.0, 'innerRadius');
  final outerRadius = Float32$.val.Value(190.0, 'outerRadius');

  final startAngle = Float32$.val.Value(0.0, 'startAngle');
  final endAngle = Float32$.val.Value(360.0, 'endAngle');
  ...
  while (!WindowShouldClose())
  {
    BeginDrawing();
      ...
      GuiSliderBar(
        Rectangle$.val.$1.set(600, 40, 120, 20),
        "StartAngle".toC,
      ...
      GuiSliderBar(
        Rectangle$.val.$1.set(600, 70, 120, 20),
        "EndAngle".toC,
      ...
      GuiSliderBar(
        Rectangle$.val.$1.set(600, 140, 120, 20),
        "InnerRadius".toC,
      ...
      GuiSliderBar(
        Rectangle$.val.$1.set(600, 170, 120, 20),
        "OuterRadius".toC,
      ...
      GuiSliderBar(
        Rectangle$.val.$1.set(600, 240, 120, 20),
        "Segments".toC,
      ...
      GuiCheckBox(
        Rectangle$.val.$1.set(600, 320, 20, 20),
        "Draw Ring".toC,
        drawRing
      );

      GuiCheckBox(
        Rectangle$.val.$1.set(600, 350, 20, 20),
        "Draw RingLines".toC,
        drawRingLines
      );

      GuiCheckBox(
        Rectangle$.val.$1.set(600, 380, 20, 20),
