...
// Run it: dart run shapes_easings_ball.dart
import '../../base_c.dart';
...
void main()
{
  ...
  InitWindow(screenWidth, screenHeight, "shapes_easings_ball".toC);
  SetTargetFPS(60);
  ...
  while (!WindowShouldClose())
  {
    ...
    if (IsKeyPressed(KeyboardKey.KEY_R.value)) framesCounter = 0;
    ...
    BeginDrawing();
      ...
      DrawCircle(ballPositionX, 200, ballRadius.toDouble(), Fade(RED, 1.0 - ballAlpha));
