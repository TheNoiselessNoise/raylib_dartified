...
// Run it: dart run shaders_spotlight_rendering.dart
...
void main()
{
  ...
  InitWindow(screenWidth, screenHeight, "shaders_spotlight_rendering".toC);
  SetTargetFPS(60);
  HideCursor();

  final texRay = LoadTexture("../resources/raysan.png".toC);
  ...
  for (int i = 0; i < MAX_SPOTS; i++)
  {
    ...
    spots[i].positionLoc = GetShaderLocation(shdrSpot, posName.toC);
    spots[i].innerLoc = GetShaderLocation(shdrSpot, innerName.toC);
    spots[i].radiusLoc = GetShaderLocation(shdrSpot, radiusName.toC);
  }
