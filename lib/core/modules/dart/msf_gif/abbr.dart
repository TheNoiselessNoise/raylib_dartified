...
int msf_gif_begin(MsfGifStateD handle, num width, num height)
  => _module.msf_gif_begin(handle, width, height);

/// See [RaylibMsfGifD.msf_gif_frame].
int msf_gif_frame(MsfGifStateD handle, Uint8List pixelData, num centiSecondsPerFame, num maxBitDepth, num pitchInBytes)
  => _module.msf_gif_frame(handle, pixelData, centiSecondsPerFame, maxBitDepth, pitchInBytes);

/// See [RaylibMsfGifD.msf_gif_end].
MsfGifResultD msf_gif_end(MsfGifStateD handle)
  => _module.msf_gif_end(handle);

/// See [RaylibMsfGifD.msf_gif_free].
void msf_gif_free(MsfGifResultD result)
...
int msf_gif_frame_to_file(MsfGifStateD handle, Uint8List pixelData, num centiSecondsPerFame, num maxBitDepth, num pitchInBytes)
...
int msf_gif_end_to_file(MsfGifStateD handle)
