...
class WaveD extends StructD<WaveD, WaveC> {
  int frameCount;
  int sampleRate;
  int sampleSize;
  int channels;
  ...
  @override
  Pointer<WaveC> allocatePointer(RaylibTemp temp, String key, [int count = 1])
    => temp.Wave$.At(key, count);

  @override
  void syncInto(RaylibTemp temp, Pointer<WaveC> p, String key)
    => writeInto(p.ref);
